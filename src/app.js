...
function findMatches(skillsList, wishList, user) {
  ...
  console.log(users);
  // usersWished = wishFound.filter(function(el,i,arr) {
  //   var j = 0;
  //   var subjGroup = el;
  //
  //   });
  ...
  // console.log(wishFound);
  // console.log(usersWished);

  // TODO: http://stackoverflow.com/questions/1885557/simplest-code-for-array-intersection-in-javascript
}
